...
data_root = os.path.join("..", "data", "all_data")
res_root = os.path.join("..", "data", "combine", "5res_analyse", "train_val_data")
...
def gen_train_val_data():
    ...
    train_dataset_coco = COCO2014Classification2(os.path.join(data_root, "coco", "coco"), "train", inp_name=coco_inp)
