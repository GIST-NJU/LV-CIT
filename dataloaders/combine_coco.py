...
class CombineCoco(data.Dataset):
    def __init__(self, root, phase="predict", transform=None, target_transform=None, inp_name=None):
        ...
        print('[dataset] CombinedImage Set=%s number of classes=%d  number of images=%d' % (
...
class CombineCoco2(CombineCoco):
    def __init__(self, root, phase="predict", transform=None, target_transform=None, inp_name=None):
        super(CombineCoco2, self).__init__(root, phase, transform, target_transform, inp_name)
